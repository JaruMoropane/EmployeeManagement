...
namespace EmployeeManagement.Controllers
{
    public class LeaveApplicationsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["StatusId"] = new SelectList(_context.SystemCodeDetails.Include(x => x.SystemCode).Where(y => y.SystemCode.Code == "PendingStatus"), "Id", "Description");
            return View();
        }
        ...
        public async Task<IActionResult> Create( LeaveApplication leaveApplication)
        {
                ...
                leaveApplication.CreatedById = "Sedzani Quan";
            ...
            ViewData["StatusId"] = new SelectList(_context.SystemCodeDetails.Include(x => x.SystemCode).Where(y => y.SystemCode.Code == "PendingStatus"), "Id", "Description", leaveApplication.StatusId);
            return View(leaveApplication);
        }
        ...
        public async Task<IActionResult> Edit(int id, LeaveApplication leaveApplication)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    leaveApplication.ModifiedById = "Sedzani Quan";
